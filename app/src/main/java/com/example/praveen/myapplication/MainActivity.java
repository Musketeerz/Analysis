...
import static com.example.praveen.myapplication.R.id.card8;
import static com.example.praveen.myapplication.R.id.chart1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //PIE
        final PieChart pieChart = (PieChart)findViewById(chart1);
        ...
        final CardView L = (CardView)findViewById(R.id.rightcard);
      ...
      //  final TextView title = (TextView)findViewById(R.id.textView2);
       ...
       // final TextView title = (TextView)findViewById(R.id.textView2);
        ...
        two.setTextColor(Color.rgb(255,255,255));
        TextView three = (TextView) findViewById(R.id.textView4);
        three.setTextColor(Color.rgb(255,255,255));

        TextView w = (TextView) findViewById(R.id.textView5);
        w.setTextColor(Color.rgb(255,255,255));
        TextView q = (TextView) findViewById(R.id.textView6);
        q.setTextColor(Color.rgb(255,255,255));

        CardView eight = (CardView)findViewById(R.id.card8);
        eight.setBackgroundColor(Color.rgb(86,134,228));

        CardView nine = (CardView)findViewById(R.id.card9);
        nine.setBackgroundColor(Color.rgb(37,95,210));
